...
const Services = () => {
    return (
        <div>
            ...
            <div className='bg-[#000000] mt-0'>
                <div className='w-[70%] mx-auto text-white'>
                <h1 className='md:text-4xl font-bold text-center mb-2 '>Services</h1>
                ...
                <div className='md:grid md:grid-cols-3 md:gap-10 '>
                    <div className='w-full h-[20rem] bg-stone-900 rounded-3xl hover:shadow-2xl'></div>
                    <div className='w-full h-[20rem] bg-stone-900 rounded-3xl hover:shadow-2xl'></div>
                    <div className='w-full h-[20rem] bg-stone-900 rounded-3xl hover:shadow-2xl'></div>
                </div>
                </div>
